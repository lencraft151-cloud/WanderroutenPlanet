...
const DICT = {
  de: {
    ...
    'trails.head': '🥾 Fertige Wanderwege in der Nähe',
    'trails.find': '🔍 Wanderwege suchen',
    'trails.searching': 'Wanderwege werden gesucht …',
    'trails.none': 'Keine fertigen Wanderwege in der Nähe gefunden.',
    'trails.err': 'Wanderwege gerade nicht abrufbar (offline?).',
    'trails.away': 'entfernt', 'trails.load': 'Laden',
    'nav.offRoute': 'Nicht auf der Route',
    'nav.offRouteSub': 'Du bist {dist} von der geplanten Route entfernt.',
    'nav.arrived': 'Ziel erreicht', 'nav.arrivedSub': 'Du bist am Ziel angekommen.',
    'nav.turnNow': 'Jetzt {dir}', 'nav.turnIn': 'In {dist} {dir}',
    'nav.thenTo': 'Dann weiter Richtung Ziel (noch {dist}).',
    'nav.straight': 'Geradeaus', 'nav.toGo': 'Noch {dist} bis zum Ziel.',
    'toast.noCompass': 'Kein Kompass gefunden – die Karte bleibt genordet.',
    'dir.right': 'rechts', 'dir.left': 'links', 'dir.sharp': 'scharf', 'dir.slight': 'leicht',
    'loop.length': 'Länge', 'loop.kind': 'Art',
    'loop.kind.hiking': 'Wandern (Standard)', 'loop.kind.city': 'Stadt – nur feste Wege',
    'loop.kind.flat': 'Flach – nicht über Berge', 'loop.kind.nature': 'Natur – ruhige Pfade',
    'loop.searching': 'Rundtour über Wege wird gesucht …',
    'loop.done': '🔄 Rundtour erzeugt – {km} km, geschlossene Schleife.',
    'loop.someBacktrack': 'Hinweis: In dieser Gegend gibt es wenige Wege – ein Teil der Tour führt auf demselben Weg zurück.',
    'loop.none': 'Keine Rundtour über Wege gefunden – anderen Startpunkt oder eine andere Länge versuchen.',
    // Splash / Fehler
  ...
  en: {
    ...
    'trails.head': '🥾 Ready-made trails nearby',
    'trails.find': '🔍 Find trails',
    'trails.searching': 'Searching trails …',
    'trails.none': 'No ready-made trails found nearby.',
    'trails.err': 'Trails not available right now (offline?).',
    'trails.away': 'away', 'trails.load': 'Load',
    'nav.offRoute': 'Off route',
    'nav.offRouteSub': 'You are {dist} away from the planned route.',
    'nav.arrived': 'Destination reached', 'nav.arrivedSub': 'You have arrived.',
    'nav.turnNow': 'Now {dir}', 'nav.turnIn': 'In {dist} {dir}',
    'nav.thenTo': 'Then continue towards the destination ({dist} left).',
    'nav.straight': 'Straight ahead', 'nav.toGo': '{dist} to the destination.',
    'toast.noCompass': 'No compass found – the map stays north-up.',
    'dir.right': 'right', 'dir.left': 'left', 'dir.sharp': 'sharp', 'dir.slight': 'slight',
    'loop.length': 'Length', 'loop.kind': 'Type',
    'loop.kind.hiking': 'Hiking (default)', 'loop.kind.city': 'City – paved paths only',
    'loop.kind.flat': 'Flat – avoid mountains', 'loop.kind.nature': 'Nature – quiet trails',
    'loop.searching': 'Searching a loop along trails …',
    'loop.done': '🔄 Loop created – {km} km, closed circuit.',
    'loop.someBacktrack': 'Note: few trails in this area – part of the tour goes back the same way.',
    'loop.none': 'No loop along trails found – try another starting point or length.',
